...
public class LoadImagingDataService extends AbstractServiceDelegate {
    private static final Logger logger = LoggerFactory.getLogger(LoadImagingDataService.class);

    public LoadImagingDataService(ProcessPluginApi api) {
        super(api);
    }
