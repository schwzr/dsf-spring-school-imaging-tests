...
public class LoadImagingStudyService extends AbstractServiceDelegate {
    private static final Logger logger = LoggerFactory.getLogger(LoadImagingStudyService.class);

    public LoadImagingStudyService(ProcessPluginApi api) {
        super(api);
    }
