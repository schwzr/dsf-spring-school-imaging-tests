...
public class LogTimeoutService extends AbstractServiceDelegate {
    private static final Logger logger = LoggerFactory.getLogger(LogTimeoutService.class);

    public LogTimeoutService(ProcessPluginApi api) {
        super(api);
    }
