...
public class ExtractImagingStudyService extends AbstractServiceDelegate {
    private static final Logger logger = LoggerFactory.getLogger(ExtractImagingStudyService.class);

    public ExtractImagingStudyService(ProcessPluginApi api) {
        super(api);
    }
